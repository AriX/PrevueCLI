...
let command2 = ConfigurationCommand(timeslotsBack: 1, timeslotsForward: 8, scrollSpeed: 2, maxAdCount: 36, maxAdLines: 8, unknown: false, unknownAdSetting: 0x0103, timezone: 6, observesDaylightSavingsTime: true, cont: true, keyboardActive: false, unknown2: false, unknown3: false, unknown4: false, unknown5: false, grph: 0x4E, videoInput: 0x58, unknown7: 0x58)
