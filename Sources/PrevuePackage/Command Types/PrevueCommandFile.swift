...
public struct PrevueCommandFile: Codable {
    public let destinations: [DataDestination]
    public let commands: [Command]
    
    public init(destinations: [DataDestination], commands: [Command]) {
...
public extension PrevueCommandFile {
