...
class CommandSerialization: XCTestCase {
    ...
    func testNewLookConfiguration() throws {
        let command = NewLookConfigurationCommand(displayFormat: .grid, textAdFlag: .satellite)
        assert(command: command, serializesToAndFrom: "55 AA 66 00 00 34 32 43 30 31 30 38 30 38 47 4E 41 45 30 31 4E 4E 4E 4E 4E 4E 4C 32 39 30 36 59 59 59 32 33 33 36 30 36 30 31 35 31 30 30 59 4E 59 43 8E 38 53 4E 4E 4E 4E 26")
    }
